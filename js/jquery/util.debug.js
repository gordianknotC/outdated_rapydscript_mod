var debug = false;
var debugcss = '#debug{	color:#000;	background:#aa3;font-size:.8em;z-index:100;padding-bottom:5px;display:none;overflow:hidden;}'
...
function log(key, value){
    ...
    if (debug == true) {
        ...
        var data = '<p style = "font-size:.8em;color:#c7a;background:#000;">' + key + ' ,<span style="color:#999">' + value + '</span></p>'
