...
console.log("\tdefault debug mode of moduleA = ", modA.debug);	

console.log("\techo = ", modA.ctrlr.echo("[moduleA.controller.echo]") || "no output");	

console.log("\tset moduleA's debug mode to True from outer scope of moduleA");	

core.RapydWeb.prototype.debug = true;	

console.log("\tcurrent debug mode = ", modA.debug);	
...
console.log("\techo = ", modB_mod.echo("[moduleB.mod.echo]" || "no output"));	
...
modA.ctrlr.get_module_variableA();	

modA.ctrlr.set_module_variableA("A1");	

console.log("\t[main][Get] module_variableA = ", moduleA.prototype.module_variableA);	

modA.ctrlr.get_module_variableA();	

modB_mod.get_module_variableA();	

modB_mod.set_module_variableA("B1");	
...
modB_mod.set_module_variableA("B2");	
