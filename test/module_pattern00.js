...
function module(fn_module) {
    _$rapyd$_unbindAll(this, true);	
    var data, scope_attr, scope, _filter, is_k_in_filter, k, v, key, value, attr;	
    ...
    if (isEmpty(fn_module.prototype)) {
        data = fn_module();	
        data.ALL = getAllExcept([ "ALL", "scope" ], fn_module);	
        scope_attr = [];	
        scope = data.scope;	
        ...
        data["scope"] = scope;	
        fn_module.prototype = data;	
        var _$rapyd$_Iter14 = scope_attr;	
...
function moduleA() {
    ...
    function sub_module() {
        ...
        function Sub() {
            ...
            this.get_module_scope_variable = _$rapyd$_bind(this.get_module_scope_variable, this);	
        }
        Sub.prototype.echo = function(s){
            var self = this;	
            _$rapyd$_unbindAll(this, true);	
            console.log("[moduleA.sub_module.echo]", s);	
        };	
        Sub.prototype.get_module_scope_variable = function(){
            var self = this;	
            _$rapyd$_unbindAll(this, true);	
